...
extension UIView{
    ...
    public var leftItem:UIButton{
        ...
        set{
            ...
            let leftItem_Hconstraints = NSLayoutConstraint.constraintsWithVisualFormat("H:|-16-[leftItem]",
                                                                                       options: [],
                                                                                       metrics: nil,
                                                                                       views: ["leftItem":newValue])
    ...
    public var rightItem:UIButton{
        ...
        set{
            ...
            let rightItem_Hconstraints = NSLayoutConstraint.constraintsWithVisualFormat("H:[rightItem]-2-|",
                                                                                        options: [],
                                                                                        metrics: nil,
                                                                                        views: ["rightItem":newValue])
